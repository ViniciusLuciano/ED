...
bool colisaoCirculoRetangulo(Circulo c, Retangulo r) {
    double xMaisProx = clamp(Circulo_get_x(c), getRetangulo_x(r), getRetangulo_max_x(r));
    double yMaisProx = clamp(Circulo_get_y(c), getRetangulo_y(r), getRetangulo_max_y(r));
